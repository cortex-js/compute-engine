 ...
 * to a .ts path that tsx then compiles). Reproduces lizeqlnn5e's span#2 at
 * ~10.4 s against source (see the "Tycho item 182" row in ROADMAP.md).
 * Optionally add `--cpu-prof` for an attributed profile.
 */
