 ...
 *   - CE 0.66.0  : benchmarks/.competitors/ce-0.66.0/dist/... (last published)
...
const OLD = resolve(ROOT, 'benchmarks/.competitors/ce-0.66.0/dist/compute-engine.min.esm.js');
...
const COLUMNS = [
  ...
  ['CE 0.66.0', 'node', [MJS, OLD, null, String(BUDGET), 'CE 0.66.0']],
...
const sidecar = {
  ...
  unit: 'ns/op',
  note: 'CE HEAD = dist working-tree build; CE 0.66.0 = last published npm tarball. Both self-report version 0.66.0 (package.json unbumped) but HEAD includes post-release core perf commits.',
  results,
};
