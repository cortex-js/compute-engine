 ...
 *   - CE 0.92.1  : benchmarks/.competitors/ce-0.92.1/dist/... (last published)
...
const OLD = resolve(ROOT, 'benchmarks/.competitors/ce-0.92.1/dist/esm-min/compute-engine.js');
...
const COLUMNS = [
  ...
  ['CE 0.92.1', 'node', [MJS, OLD, null, String(BUDGET), 'CE 0.92.1']],
...
const sidecar = {
  ...
  unit: 'ns/op',
  note: 'CE HEAD = dist working-tree build; CE 0.92.1 = last published npm tarball.',
  results,
};
