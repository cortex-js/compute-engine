 ...
 *   - CE 0.91.0  : benchmarks/.competitors/ce-0.91.0/dist/... (last published)
...
const OLD = resolve(ROOT, 'benchmarks/.competitors/ce-0.91.0/dist/esm-min/compute-engine.js');
...
const COLUMNS = [
  ...
  ['CE 0.91.0', 'node', [MJS, OLD, null, String(BUDGET), 'CE 0.91.0']],
...
const sidecar = {
  ...
  unit: 'ns/op',
  note: 'CE HEAD = dist working-tree build; CE 0.91.0 = last published npm tarball.',
  results,
};
