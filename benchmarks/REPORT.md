...
|---|---|---|
| Compute Engine — current build | `0.124.2` @ `de52c8d9` (freshly built from `src/`) | Node v22.13.1 |
...
|---|---|---|---|---|---|---|---|---|
| | **Core tier** |  |  |  |  |  |  |  |
| N01 | $\pi^2$ <sub>(50d)</sub> | 10 | 10.0 | 10 | 175 | 69 | 🟡 <sub>16 digits</sub> 3.9 | ⚠️ |
| N02 | $e$ <sub>(50d)</sub> | 0.58 | 0.58 | 0.67 | 159 | 10 | 🟡 <sub>16 digits</sub> 3.1 | ⚠️ |
| N03 | $\sqrt2$ <sub>(50d)</sub> | 6.1 | 5.9 | 7.3 | 222 | 77 | 🟡 <sub>17 digits</sub> 4.9 | ⚠️ |
| N04 | $100!$ <sub>(exact)</sub> | 11 | 10 | 8.5 | 258 | 111 | ❌ <sub>inexact</sub> 10 | ⚠️ |
| N05 | $e^{\pi}$ <sub>(40d)</sub> | 10 | 10 | 11 | 189 | 385 | 🟡 <sub>17 digits</sub> 4.8 | ⚠️ |
| | **Hard tier** |  |  |  |  |  |  |  |
| N06 | $\pi$ <sub>(200d)</sub> | 0.54 | 0.58 | 0.54 | 160 | 11 | 🟡 <sub>16 digits</sub> 3.2 | ⚠️ |
| N07 | $\zeta(3)$ <sub>(40d)</sub> | 278 | 244 | 304 | 264 | ❌ <sub>8 digits</sub> 5742 | — | ⚠️ |
| N08 | $\Gamma(\tfrac13)$ <sub>(40d)</sub> | 166 | 150 | 165 | 241 | ⚠️ | — | ⚠️ |
| N09 | $W(1)$ <sub>(40d)</sub> | 54 | 53 | 60 | 664 | — | — | ⚠️ |
|  | **median µs** | **10** | **10** | **10** | **222** | **77** | **4.8** | — |
...
|---|---|---|---|---|---|---|---|
| | **Core tier** |  |  |  |  |  |  |
| S01 | $\frac{x^2-1}{x-1}$ | 0.16 | 0.17 | 0.25 | 7.94 | 🟡 <sub>not simplified</sub> 0.94 | ⚠️ |
| S02 | $\sin^2 x+\cos^2 x$ | 0.09 | 0.19 | 0.11 | 8.43 | 🟡 <sub>not simplified</sub> 0.89 | ⚠️ |
| S03 | $(x+1)^2-(x-1)^2$ | 0.28 | 0.30 | 0.40 | 5.96 | 🟡 <sub>not simplified</sub> 1.23 | ⚠️ |
| S04 | $\frac{x^3-x}{x}$ | 0.14 | 0.15 | 0.16 | 4.20 | 1.22 | ⚠️ |
| S05 | $x^{-1/2}-\frac{1}{\sqrt x}$ | 0.09 | 0.09 | 0.11 | 0.23 | 🟡 <sub>not simplified</sub> 1.55 | ⚠️ |
| | **Hard tier** |  |  |  |  |  |  |
| S06 | $\sqrt6\,x+\sqrt2\,x$ | 0.28 | 0.32 | 0.36 | 5.57 | 1.02 | ⚠️ |
| S07 | $\ln x+\ln(x+1)$ | 0.22 | 0.34 | 0.22 | 6.10 | 🟡 <sub>not simplified</sub> 0.66 | ⚠️ |
| S08 | $\sqrt{3+2\sqrt2}$ | 0.09 | 0.12 | 0.11 | 🟡 <sub>not simplified</sub> 3.51 | 🟡 <sub>numeric only</sub> 0.72 | ⚠️ |
| S09 | $\frac{x^3-1}{x-1}$ | 0.12 | 0.13 | 0.18 | 8.83 | 🟡 <sub>not simplified</sub> 1.00 | ⚠️ |
|  | **median ms** | **0.14** | **0.17** | **0.18** | **5.96** | **1.00** | — |
...
|---|---|---|---|---|---|---|---|
| | **Core tier** |  |  |  |  |  |  |
| D01 | $\tfrac{d}{dx}\sin x$ | 0.03 | 0.03 | 0.02 | 0.33 | 0.88 | ⚠️ |
| D02 | $\tfrac{d}{dx}x^5$ | 0.09 | 0.09 | 0.09 | 0.50 | 0.84 | ⚠️ |
| D03 | $\tfrac{d}{dx}\tan x$ | 0.05 | 0.05 | 0.04 | 2.07 | 0.78 | ⚠️ |
| D04 | $\tfrac{d}{dx}x^2\sin x$ | 0.24 | 0.23 | 0.25 | 2.05 | 1.73 | ⚠️ |
| D05 | $\tfrac{d}{dx}\sin(x^2)$ | 0.12 | 0.10 | 0.10 | 1.43 | 1.37 | ⚠️ |
| | **Hard tier** |  |  |  |  |  |  |
| D06 | $\tfrac{d}{dx}x^x$ | 0.10 | 0.10 | 0.10 | 1.78 | 1.76 | ⚠️ |
| D07 | $\tfrac{d}{dx}\arcsin x$ | 0.16 | 0.17 | 0.16 | 2.92 | 1.24 | ⚠️ |
| D08 | $\tfrac{d}{dx}\ln(\sin x)$ | 0.06 | 0.06 | 0.06 | 1.08 | 1.14 | ⚠️ |
| D09 | $\tfrac{d}{dx}\sqrt{1-x^2}$ | 0.29 | 0.29 | 0.31 | 5.87 | 2.17 | ⚠️ |
|  | **median ms** | **0.10** | **0.10** | **0.10** | **1.78** | **1.24** | — |
...
|---|---|---|---|---|---|---|
| | **Core tier** |  |  |  |  |  |
| A01 | $\int x^2\,dx$ | 0.15 | 0.16 | 0.17 | 0.37 | ⚠️ |
| A02 | $\int\sin x\,dx$ | 0.05 | 0.23 | 0.05 | 1.18 | ⚠️ |
| A03 | $\int x e^x\,dx$ | 0.19 | 1.02 | 0.26 | 6.68 | ⚠️ |
| A04 | $\int\frac{1}{1+x^2}\,dx$ | 0.11 | 0.24 | 0.12 | 9.28 | ⚠️ |
| A05 | $\int\frac{x}{x^2+1}\,dx$ | 0.30 | 1.22 | 0.34 | 6.44 | ⚠️ |
| | **Hard tier** |  |  |  |  |  |
| A06 | $\int\frac{1}{x^3+1}\,dx$ | 2.33 | 13.6 | 2.11 | 24.1 | ⚠️ |
| A07 | $\int\frac{1}{\sqrt x}\,dx$ | 0.12 | 0.19 | 0.11 | 0.69 | ⚠️ |
| A08 | $\int e^{-x^2}\,dx$ | 0.27 | 0.68 | 0.38 | 24.9 | ⚠️ |
| A09 | $\int\frac{x}{\sqrt{1-x^2}}\,dx$ | 0.32 | 1.73 | 0.34 | 24.0 | ⚠️ |
| CR1 | $\int\frac{\sqrt x}{1+x}\,dx$ | **∅** | 1.54 | ∅ | 21.3 | ⚠️ |
| CR2 | $\int\frac{x}{(1+x)^{1/3}}\,dx$ | **∅** | 1.37 | ∅ | 114 | ⚠️ |
| CR3 | $\int\frac{x^2}{(1+x)^{1/3}}\,dx$ | **∅** | 1.77 | ∅ | 208 | ⚠️ |
|  | **median ms** | **0.19** | **1.22** | **0.26** | **21.3** | — |
...
|---|---|---|---|---|
| A06 | $\int\frac{1}{x^3+1}\,dx$ | 2328 | 13589 | 5.84× |
| A03 | $\int x e^x\,dx$ | 191 | 1024 | 5.36× |
| A09 | $\int\frac{x}{\sqrt{1-x^2}}\,dx$ | 324 | 1733 | 5.35× |
| A02 | $\int\sin x\,dx$ | 49 | 226 | 4.65× |
| CR1 | $\int\frac{\sqrt x}{1+x}\,dx$ | 358 | 1538 | 4.29× |
| A05 | $\int\frac{x}{x^2+1}\,dx$ | 302 | 1220 | 4.04× |
| CR3 | $\int\frac{x^2}{(1+x)^{1/3}}\,dx$ | 440 | 1774 | 4.03× |
| CR2 | $\int\frac{x}{(1+x)^{1/3}}\,dx$ | 407 | 1367 | 3.35× |
| A08 | $\int e^{-x^2}\,dx$ | 275 | 678 | 2.47× |
| CE1 | $\lim_{x\to0}\tfrac{\sin x}{x}$ | 69 | 167 | 2.43× |
| A04 | $\int\frac{1}{1+x^2}\,dx$ | 109 | 238 | 2.19× |
| CE4 | $\int_{-\infty}^{\infty} e^{-x^2}\,dx$ | 312 | 672 | 2.15× |
| S02 | $\sin^2 x+\cos^2 x$ | 88 | 188 | 2.13× |
| A07 | $\int\frac{1}{\sqrt x}\,dx$ | 116 | 193 | 1.67× |
| S07 | $\ln x+\ln(x+1)$ | 218 | 339 | 1.55× |
| S08 | $\sqrt{3+2\sqrt2}$ | 93 | 123 | 1.33× |
| CE2 | $\lim_{x\to\infty}(1+\tfrac1x)^x$ | 1485 | 1799 | 1.21× |
| S06 | $\sqrt6\,x+\sqrt2\,x$ | 276 | 317 | 1.15× |
| S09 | $\frac{x^3-1}{x-1}$ | 116 | 132 | 1.14× |
| D03 | $\tfrac{d}{dx}\tan x$ | 47 | 52 | 1.10× |
| A01 | $\int x^2\,dx$ | 147 | 158 | 1.08× |
| D05 | $\tfrac{d}{dx}\sin(x^2)$ | 118 | 105 | **0.89× (win)** |
| N07 | $\zeta(3)$ | 278 | 244 | **0.87× (win)** |
| CE3 | $\int_1^2\tfrac1x\,dx$ | 128 | 95 | **0.74× (win)** |
