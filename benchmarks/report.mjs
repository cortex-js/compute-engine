...
//   ce-pub       Compute Engine, last published npm release   (0.73.0 by default)
...
//   CE_PUBLISHED_VERSION label for the published column (default 0.73.0)
...
const PUBLISHED_VERSION = process.env.CE_PUBLISHED_VERSION || '0.73.0';
