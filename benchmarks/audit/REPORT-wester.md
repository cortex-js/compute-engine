...
- **CE 26/48** · **CE+R/F 32/48** · **SymPy 36/48** · **Mathematica 44/48** correct.
- Against the **Mathematica** baseline, base CE trails on **18** cases; **6** of those recovered by Rubi/Fungrim.

| Operation | CE | CE+R/F | SymPy | Mathematica |
|---|--:|--:|--:|--:|
| Indefinite ∫ | 1/8 | 7/8 | 7/8 | 8/8 |
