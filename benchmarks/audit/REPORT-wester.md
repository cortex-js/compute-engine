...
- **CE 31/48** · **CE+R/F 38/48** · **SymPy 36/48** · **Mathematica 44/48** correct.
- Against the **Mathematica** baseline, base CE trails on **14** cases; **7** of those recovered by Rubi/Fungrim.

| Operation | CE | CE+R/F | SymPy | Mathematica |
|---|--:|--:|--:|--:|
| Indefinite ∫ | 1/8 | 8/8 | 7/8 | 8/8 |
| Definite ∫ | 5/5 | 5/5 | 0/5 | 4/5 |
...
## Where CE trails Mathematica (14)
