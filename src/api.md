...
Use `isBoxedFunction()` type guard to narrow, then access
...
Use `isBoxedNumber()` type guard to narrow, then access
...
Use `isBoxedString()` type guard to narrow, then access
...
Use `isBoxedSymbol()` type guard to narrow, then access
...
Use `isBoxedTensor()` type guard to narrow, then access
