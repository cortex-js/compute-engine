...
export function antiderivative(
  ...
  if (fn.operator === 'Block' && isBoxedFunction(fn))
    return antiderivative(fn.op1, index);
  if (fn.operator === 'Delimiter' && isBoxedFunction(fn))
    return antiderivative(fn.op1, index);
  ...
  if (fn.operator === 'Negate' && isBoxedFunction(fn))
