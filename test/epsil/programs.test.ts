...
//
// Complete example programs, exercising Epsil end-to-end: control flow,
...
// `src/epsil/docs/examples.md` directly so the published snippets cannot rot;
...
function run(
  source: string
): ReturnType<typeof executeEpsil> & { text: string } {
...
describe('EPSIL PROGRAMS — iteration and accumulation', () => {
...
describe('EPSIL PROGRAMS — recursion', () => {
...
describe('EPSIL PROGRAMS — exact and symbolic computation', () => {
...
describe('EPSIL PROGRAMS — strings', () => {
...
describe('EPSIL PROGRAMS — reproducible randomness', () => {
...
describe('EPSIL PROGRAMS — collections', () => {
...
describe('EPSIL PROGRAMS — collection literals evaluate their elements', () => {
...
describe('EPSIL PROGRAMS — higher-order functions', () => {
...
describe('EPSIL PROGRAMS — calculus', () => {
...
describe('EPSIL PROGRAMS — units and measurements', () => {
...
describe('EPSIL PROGRAMS — dictionaries', () => {
...
describe('EPSIL PROGRAMS — control flow and predicates', () => {
...
describe('EPSIL PROGRAMS — integers and number theory', () => {
...
describe('EPSIL PROGRAMS — complex numbers', () => {
...
describe('EPSIL PROGRAMS — linear algebra', () => {
...
describe('EPSIL PROGRAMS — exact sums and special values', () => {
...
describe('EPSIL PROGRAMS — equations, exactly solved', () => {
...
//
describe('EPSIL PROGRAMS — spread arguments', () => {
...
//
describe('EPSIL PROGRAMS — destructuring declarations', () => {
...
//
describe('EPSIL PROGRAMS — destructuring assignment', () => {
