import { Lexer, tokenize } from '../../src/epsil/lexer';
import { Token, TokenType } from '../../src/epsil/tokens';
...
describe('EPSIL LEXER — operators (maximal munch)', () => {
...
describe('EPSIL LEXER — brackets and punctuation', () => {
...
describe('EPSIL LEXER — comments and trivia', () => {
...
describe('EPSIL LEXER — LaTeX islands', () => {
...
describe('EPSIL LEXER — single-line strings', () => {
...
describe('EPSIL LEXER — extended strings', () => {
...
describe('EPSIL LEXER — multiline strings', () => {
...
describe('EPSIL LEXER — error tokens', () => {
...
describe('EPSIL LEXER — offsets and trivia flags', () => {
...
describe('FANCY-UNICODE SYMBOL ALIASES', () => {
  const { tokenize: lex } = require('../../src/epsil/lexer');
