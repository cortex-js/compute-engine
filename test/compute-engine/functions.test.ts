...
//   test('Expression', () =>
//     expect(evaluate(['f2', 10])).toMatchInlineSnapshot(`["f2", 10]`)); // @fixme
//   test('JS Function', () =>
...
//     expect(evaluate(['f1'])).toMatchInlineSnapshot(`["Add", "_1", 1]`)); // @fixme
...
//     expect(evaluate(['f2', 10, 20])).toMatchInlineSnapshot(`["f2", 10, 20]`)); // @fixme
...
//   test('Anon Param: F8', () =>
//     expect(evaluate(['f8', 10])).toMatchInlineSnapshot(`["f8", 10]`)); // @fixme
//   test('Anon Param: F9', () =>
//     expect(evaluate(['f9', 10])).toMatchInlineSnapshot(`["f9", 10]`)); // @fixme
// });
