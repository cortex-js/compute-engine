...
describe('OPERATOR multiply', () => {
  ...
  test('3\\pi5', () =>
    expect(check('3\\pi5')).toMatchInlineSnapshot(`
      ...
      N         = {
        num: "47.12388980384689857693965074919254326295754099062658731462416888461724609429313497942052238013175602"
      }
    `));
});
...
describe('OPERATOR divide', () => {
  test('\\frac12', () =>
    expect(check('\\frac12')).toMatchInlineSnapshot(`
      ...
      N         = 0.5
    `));
  test('\\frac31', () => expect(check('\\frac31')).toMatchInlineSnapshot(`3`));
  test('\\frac75', () =>
