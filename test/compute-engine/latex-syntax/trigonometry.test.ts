...
describe('TRIGONOMETRIC FUNCTIONS implicit arguments', () => {
  test(`\\cos x + 1`, () =>
    expect(check('\\cos x + 1')).toMatchInlineSnapshot(`
      'box      = ["Add", ["Cos", "x"], 1]
      simplify  = ["Add", 1, ["Divide", ["Subtract", ["Exp", ["Multiply", "ImaginaryUnit", ["Add", ["Multiply", ["Rational", 1, 2], "Pi"], "x"]]], ["Exp", ["Multiply", "ImaginaryUnit", ["Subtract", ["Multiply", ["Rational", -1, 2], "Pi"], "x"]]]], ["Complex", 0, 2]]]
      evaluate  = ["Add", 1, ["Cos", "x"]]'
    `));
  test(`\\cos x - \\sin x`, () =>
    expect(check('\\cos x - \\sin x')).toMatchInlineSnapshot(`
      'box      = ["Subtract", ["Cos", "x"], ["Sin", "x"]]
      simplify  = ["Subtract", ["Divide", ["Subtract", ["Exp", ["Multiply", "ImaginaryUnit", ["Add", ["Multiply", ["Rational", 1, 2], "Pi"], "x"]]], ["Exp", ["Multiply", "ImaginaryUnit", ["Subtract", ["Multiply", ["Rational", -1, 2], "Pi"], "x"]]]], ["Complex", 0, 2]], ["Divide", ["Subtract", ["Exp", ["Multiply", "ImaginaryUnit", "x"]], ["Exp", ["Negate", ["Multiply", "ImaginaryUnit", "x"]]]], ["Complex", 0, 2]]]
  ...
  test(`\\cos \\frac{x}{2}^2`, () =>
    expect(check('\\cos \\frac{x}{2}^2')).toMatchInlineSnapshot(`
      ...
      simplify  = ["Divide", ["Subtract", ["Exp", ["Multiply", "ImaginaryUnit", ["Add", ["Multiply", ["Rational", 1, 2], "Pi"], ["Multiply", ["Rational", 1, 4], ["Square", "x"]]]]], ["Exp", ["Multiply", "ImaginaryUnit", ["Add", ["Multiply", ["Rational", -1, 2], "Pi"], ["Multiply", ["Rational", -1, 4], ["Square", "x"]]]]]], ["Complex", 0, 2]]
...
describe('TRIGONOMETRIC FUNCTIONS', () => {
  test(`\\cos(k\\pi)`, () =>
    expect(check('\\cos(k\\pi)')).toMatchInlineSnapshot(`
      ...
      simplify  = ["Divide", ["Subtract", ["Exp", ["Multiply", "ImaginaryUnit", ["Add", ["Multiply", ["Rational", 1, 2], "Pi"], ["Multiply", "Pi", "k"]]]], ["Exp", ["Multiply", "ImaginaryUnit", ["Subtract", ["Multiply", ["Rational", -1, 2], "Pi"], ["Multiply", "Pi", "k"]]]]], ["Complex", 0, 2]]
      evaluate  = ["Cos", ["Multiply", "Pi", "k"]]
      N         = ["Cos", ["Multiply", ["num": "3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068"], "k"]]'
    `));
  test(`\\cos(\\frac{\\pi}{5})`, () =>
